...
def proxyget(url): # scarica proxy da altri siti
	try:
		...
		print("\nAn proizoshla oshibka, perekhod na sleduyushchiy sayt.")
...
def main(): # funzione effettiva del programma.
	try:
		...
		print("\n")
		while True:
			choice = input("\nKhotite proverit socks? [Y/n] > ") # scelta di quello che vuole l'utente
			...
			if choice == 'N' or choice == 'n' or choice == 'no' or choice == 'No': # altrimenti esce
				...
				print ("Pozhaluysta, napishite pravilno.")
	except:
		print ("\n\nAn Voznikla oshibka.")
